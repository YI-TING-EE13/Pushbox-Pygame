...
TRANSLATIONS = {
    "en": {
        ...
        # Gameplay HUD / Overlays
        "gameplay.hud_moves": "Moves: {moves}",
        "gameplay.hud_pushes": "Pushes: {pushes}",
        "gameplay.hud_time": "Time: {time}",
        "gameplay.hud_help_prompt": "Press H for Help",
        "gameplay.hud_control": "Control: {scheme}",
        "gameplay.onboarding_complete": (
            "Tip: Targets turn green when solved. Complete!"
        ),
        "gameplay.onboarding_move": "Tip: Use WASD or Arrow Keys to move",
        "gameplay.onboarding_adjacent": "Tip: Walk next to a box and push it forward",
        "gameplay.onboarding_push": (
            "Tip: Move next to a box and push it to the red target"
        ),
        "gameplay.win_title": "MISSION COMPLETE!",
        "gameplay.best_moves": "History Best: {moves} moves",
        "gameplay.new_record": "🏆 NEW RECORD!",
        "gameplay.win_hint": "Press N: Next | R: Replay | M: Menu",
        "gameplay.deadlock_title": "DEADLOCK!",
        "gameplay.deadlock_msg": "Box is stuck. Level cannot be solved.",
        "gameplay.deadlock_hint": "Press Z: Undo | R: Restart | M: Menu",
        "gameplay.pause_title": "PAUSED",
        "gameplay.pause_msg": "Game is paused",
        "gameplay.pause_resume": "Esc / P : Resume Game",
        "gameplay.pause_restart": "R : Restart Level",
        "gameplay.pause_settings": "S : Settings",
        "gameplay.pause_menu": "M : Return to Menu",
        "gameplay.help_title": "Game Controls",
        "gameplay.help_move": "Move: Arrow Keys / WASD",
        "gameplay.help_undo": "Undo: Z / Backspace",
        "gameplay.help_redo": "Redo: Y / R",
        "gameplay.help_reset": "Reset: F5",
        "gameplay.help_menu": "Menu: M",
        "gameplay.help_quit": "Quit: Ctrl+Q",
        "gameplay.help_dismiss": "Press any key to resume game",
        # Solver hints
        "hint.move": "Hint: Please move along the highlighted path",
        "hint.completed": "Hint: Level is already solved!",
        "hint.complex": ("Hint: State space is too complex, no reliable hint found."),
        "hint.unsolvable": (
            "Hint: Level may be unsolvable. Press Z to Undo or F5 to Reset."
        ),
        "hint.invalid": "Hint: Current level data cannot generate hints.",
    },
    "zh-TW": {
        # Common / Buttons
        "button.back": "返回",
        ...
        # Gameplay HUD / Overlays
        "gameplay.hud_moves": "步數: {moves}",
        "gameplay.hud_pushes": "推動: {pushes}",
        "gameplay.hud_time": "時間: {time}",
        "gameplay.hud_help_prompt": "按 H 顯示說明",
        "gameplay.hud_control": "控制: {scheme}",
        "gameplay.onboarding_complete": "提示：目標點變為綠色，通關！",
        "gameplay.onboarding_move": "提示：按 WASD 或方向鍵進行移動",
        "gameplay.onboarding_adjacent": "提示：走到箱子旁，繼續向前推動它",
        "gameplay.onboarding_push": "提示：走到箱子旁，將它推向紅色的目標點",
        "gameplay.win_title": "MISSION COMPLETE!",
        "gameplay.best_moves": "歷史最佳: {moves} 步",
        "gameplay.new_record": "🏆 新紀錄!",
        "gameplay.win_hint": "按 N 下一關 / R 重玩 / M 選單",
        "gameplay.deadlock_title": "死鎖!",
        "gameplay.deadlock_msg": "箱子被卡住了，這一關無法繼續。",
        "gameplay.deadlock_hint": "按 Z 撤銷 / R 重玩 / M 選單",
        "gameplay.pause_title": "暫停",
        "gameplay.pause_msg": "遊戲已暫停",
        "gameplay.pause_resume": "Esc / P : 繼續遊戲 (Resume)",
        "gameplay.pause_restart": "R : 重置關卡 (Restart)",
        "gameplay.pause_settings": "S : 遊戲設定 (Settings)",
        "gameplay.pause_menu": "M : 返回主選單 (Main Menu)",
        "gameplay.help_title": "遊戲控制",
        "gameplay.help_move": "移動: ↑↓←→ / WASD",
        "gameplay.help_undo": "撤銷: Z / Backspace",
        "gameplay.help_redo": "重做: Y / R",
        "gameplay.help_reset": "重置: F5",
        "gameplay.help_menu": "選單: M",
        "gameplay.help_quit": "退出: Ctrl+Q",
        "gameplay.help_dismiss": "按任意鍵返回遊戲",
        # Solver hints
        "hint.move": "提示：請沿著高亮方向移動",
        "hint.completed": "目前已在完成狀態",
        "hint.complex": "此局面較複雜，暫時找不到可靠提示。",
        "hint.unsolvable": "目前局面可能無法完成，建議按 Z 撤銷或 F5 重置。",
        "hint.invalid": "目前關卡資料無法產生提示。",
    },
}
