...
- **Built-in Levels**: 25 pre-configured default levels of graduating difficulty, featuring concise difficulty, theme, and box count metadata badges visible in the Level Selector.
